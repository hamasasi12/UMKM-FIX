      ...
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center" data-aos="zoom-out">
            <h1>Welcome to <span>Website Tahura Camping</span></h1>
            <p>Ini adalah tampilan depan dari tahura camping</p>
            <div class="d-flex">
      ...
      <div class="container">
        ...
        <div class="row gy-3">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            <img src="{{ asset('assets/img/tahura.jpg') }}" alt="" class="img-fluid">
          </div>
